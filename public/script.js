document.addEventListener('DOMContentLoaded', function () {
    ...
    function validateField(field) {
      ...
      for (const rule of rules) {
        ...
        if (validators[ruleName] && !validators[ruleName](value, ruleParam)) {
          valid = false;
          message = errorMessages[ruleName] || 'Invalid value.';
          break;
        }
      }
  ...
  function applyScrollAnimations() {
    const elements = document.querySelectorAll(OBSERVED_SELECTORS);
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'b3443f6c-2472-4045-ade2-e55602b2f045',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'b3443f6c-2472-4045-ade2-e55602b2f045';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'b3443f6c-2472-4045-ade2-e55602b2f045';
